    ...
    <>
      <div className="md:p-8 p-4 m-1  bg-[#ffffff]">
        <div className="flex gap-[5vw] flex-col md:flex-row bg-[#ffffff]">
          <div className="rounded-xl bg-[#e2f6fc] hover:border ml-[-11px]  hover:border-blue-400 w-[95vw] md:w-[30%] h-[20vh] md:h-[90vh] flex flex-row md:flex-col">
            <img
              src={sherdil}
              alt=""
            ...
            <div className="flex flex-col justify-center items-center w-full mx-auto">
              ...
              <p className="md:mx-3 md:text-base text-xs mx-auto poppins-regular ">
                <span className="hidden md:inline">Passionate about</span> <strong>Core CS</strong> and <strong>building things</strong>
              </p>
              <p className="poppins-regular md:text-base text-xs">Fullstack | Web | Mobile</p>
